...
class TrendingPosts extends PostsWidget
{
	...
	public function __construct()
	{
		$widget_options = [
			...
			'description' => esc_html__('Displays trending posts (by views from last 30 days).', 'toolkit'),
		];

		parent::__construct(
			'vlt_widget_trending_posts',
			esc_html__('VLThemes: Trending Posts', 'toolkit'),
			$widget_options,
		);
	}
	...
	public function widget($args, $instance): void
	{
		...
		switch ($layout) {
			...
			case 'slider':
				?>
				<div class="vlt-widget-post-slider swiper-container swiper" data-tooltip="<?php esc_attr_e('Swipe', 'toolkit'); ?>">
