		...
		<div class="vlt-widget">
			...
			<div class="vlt-widget__content">
				...
				<div class="postbox-header pb-sm">
					...
					<a target="_blank" href="<?php echo esc_url($this->elementor_partner_url); ?>" class="button button-primary"><?php esc_html_e('Explore More', 'vlt-helper'); ?></a>

				</div>

				<p class="mt-sm"><?php esc_html_e('A visual drag-and-drop builder for designing forms, posts, pages, and more.', 'vlt-helper'); ?></p>
				...
				<div class="postbox-header pb-sm mt-lg">
					...
					<a target="_blank" href="<?php echo esc_url($this->fornex_partner_url); ?>" class="button button-primary"><?php esc_html_e('Explore More', 'vlt-helper'); ?></a>

				</div>

				<p class="mt-sm"><?php esc_html_e('A hosting provider offering dedicated servers, VPS, shared hosting, VPNs, and backup services.', 'vlt-helper'); ?></p>
