...
<div class="vlt-masonry-grid">
				...
				<div class="notice notice-info inline mt-sm">
					<p>
						...
						printf(
							...
							'<a target="_blank" href="' . esc_url($this->support_policy_url) . '">' . esc_html__('Support Policy', 'vlt-helper') . '</a>'
						);
						?>
					</p>
				</div>
	...
	<div class="vlt-masonry-item">
		<div class="vlt-widget">
			...
			<div class="vlt-widget__title">
				<mark><?php esc_html_e('Our Partners *', 'vlt-helper'); ?></mark>
			</div>
			...
			<div class="vlt-widget__content">
				...
				<p class="mt-sm"><?php esc_html_e('Most advanced website builder plugin, allowing you to visually design forms, posts, WooCommerce, slides and more.', 'vlt-helper'); ?></p>
				<a target="_blank" href="<?php echo esc_url($this->elementor_partner_url); ?>" class="button button-primary mt-sm"><?php esc_html_e('Explore More', 'vlt-helper'); ?></a>
				...
				<p class="mt-sm"><?php esc_html_e('Fornex provides a range of hosting types and services which include dedicated servers, VPS, shared web hosting, VPN solutions, and backup resources.', 'vlt-helper'); ?></p>
				<a target="_blank" href="<?php echo esc_url($this->fornex_partner_url); ?>" class="button button-primary mt-sm"><?php esc_html_e('Explore More', 'vlt-helper'); ?></a>

				<p class="small mt-sm"><?php esc_html_e('* Here we provide some partners and services that we use.', 'vlt-helper'); ?></p>
